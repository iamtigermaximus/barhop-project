...
//     { name: "Turku", value: "turku", center: { lat: 60.4518, lng: 22.2666 } },
//     // { name: "Espoo", value: "espoo", center: { lat: 60.2055, lng: 24.6559 } },
//     // { name: "Vantaa", value: "vantaa", center: { lat: 60.2941, lng: 25.0409 } },
//     // { name: "Oulu", value: "oulu", center: { lat: 65.0121, lng: 25.4651 } },
//     // {
//     //   name: "Jyväskylä",
//     //   value: "jyvaskyla",
//     //   center: { lat: 62.2426, lng: 25.7473 },
//     // },
//     // { name: "Lahti", value: "lahti", center: { lat: 60.9827, lng: 25.6612 } },
//     // { name: "Kuopio", value: "kuopio", center: { lat: 62.8924, lng: 27.677 } },
//     // { name: "Pori", value: "pori", center: { lat: 61.4851, lng: 21.7974 } },
//     // {
//     //   name: "Kouvola",
//     //   value: "kouvola",
//     //   center: { lat: 60.8685, lng: 26.7041 },
//     // },
//     // {
//     //   name: "Joensuu",
//     //   value: "joensuu",
...
//     //   name: "Lappeenranta",
//     //   value: "lappeenranta",
//     //   center: { lat: 61.0588, lng: 28.1887 },
//     // },
//     // {
//     //   name: "Hämeenlinna",
//     //   value: "hameenlinna",
//     //   center: { lat: 61.0028, lng: 24.4647 },
//     // },
//     // { name: "Vaasa", value: "vaasa", center: { lat: 63.096, lng: 21.6158 } },
//   ];
...
// UPDATED: Filter section with better mobile layout
const FilterSection = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
...
// UPDATED: City Dropdown with responsive width
const CityDropdown = styled.select`
  background: rgba(30, 41, 59, 0.8);
  border: 1px solid rgba(139, 92, 246, 0.3);
  color: #e2e8f0;
...
// UPDATED: Sort Filter with responsive width
const SortFilter = styled.select`
  background: rgba(30, 41, 59, 0.8);
  border: 1px solid rgba(139, 92, 246, 0.3);
  color: #e2e8f0;
...
// UPDATED: Location Status with better mobile behavior
const LocationStatus = styled.div`
  display: flex;
  align-items: center;
  gap: 0.5rem;
...
// NEW: Filters Row for mobile layout
  ...
  return (
    <>
      <MarketplaceContainer>
        ...
        {/* UPDATED: Filters and Location with better mobile layout */}
        <FilterSection>
          <FiltersRow>
            <CityFilter>
              <div
