...
export default function UserProfile() {
  ...
  const fetchSocialProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log("📊 Social profile object:", data.socialProfile);
        console.log("🎭 Vibe value:", data.socialProfile?.vibe);
        console.log("🎭 Interests value:", data.socialProfile?.interests);
        console.log("🎭 Interests type:", typeof data.socialProfile?.interests);
        console.log(
          "🎭 Interests is array:",
          Array.isArray(data.socialProfile?.interests)
        );
  ...
  // Debug effect to log when socialProfile changes
  useEffect(() => {
    console.log("🔄 Social profile state updated:", {
      hasSocialProfile: !!socialProfile,
      vibe: socialProfile?.vibe,
      interests: socialProfile?.interests,
      fullProfile: socialProfile,
    });
  }, [socialProfile]);
