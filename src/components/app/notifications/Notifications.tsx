...
//       switch (notification.type) {
//         case "MESSAGE":
//           if (notification.crawlId && !notification.chatroomId) {
//             // Get the chatroomId from the crawlId
//             const res = await fetch(
//               `/api/chat/by-crawl/${notification.crawlId}`,
//             );
//             const { chatroomId } = await res.json();
//             if (chatroomId) {
//               targetUrl = `/app/chat/private/${chatroomId}`;
//             }
//           } else if (notification.chatroomId) {
//             targetUrl = `/app/chat/private/${notification.chatroomId}`;
//           }
...
//         default:
//           console.log("No action for type:", notification.type);
//           return;
//       }
...
const StatusDot = styled.div<{ $isConnected: boolean }>`
  ...
  background: ${(props) => (props.$isConnected ? "#22c55e" : "#ef4444")};
  animation: ${(props) =>
    props.$isConnected ? "pulse 1.5s infinite" : "none"};
